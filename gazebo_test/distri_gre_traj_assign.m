...
% 1. calculate the number of targets tracked by the distributed greedy algorithm and
% the number of targets after best removal
% 2. assign each uav a greedy trajectory in each clique
% 3. publish desired pos message for each uav(same as 2. assign trajectory)
function distri_gre_traj_assign(target_cover)
    ...
    for i = 1 : length(nonovlap_cliqs_G)
        ...
        [r_tra_gre_c]= greedy_fun(nonovlap_cliqs_G{i}, [ ], target_cover); 
        r_tra_assign = [r_tra_assign; r_tra_gre_c];
