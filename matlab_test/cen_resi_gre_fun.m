function    [n_cen_resi_atk, gre_att_rate_cen_resi, com_cen_resi, t_cen_resi] = ...
    ...
    [n_cen_resi_atk]= gre_attack(tar_set_rtra, r_tra_resi_cen);
    % worst attack rate
     gre_att_rate_cen_resi = n_cen_resi_atk/n_cen_resi;
